...
Я загружаю страницу с опциями по ремонту телефонов и перехожу в детали, чтобы узнать стоимость. При каждом переходе показана загрузке, при ошибке вылезхлает окно с кнопкой "Повторить запрос"
